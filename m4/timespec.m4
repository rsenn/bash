...
[
  ...
  if test $bash_cv_sys_struct_timespec_in_time_h = yes; then
    AC_DEFINE([HAVE_STRUCT_TIMESPEC],,[desc])
    AC_DEFINE([TIME_H_DEFINES_STRUCT_TIMESPEC],,[desc])
    ...
    if test $bash_cv_sys_struct_timespec_in_sys_time_h = yes; then
      ...
      AC_DEFINE([HAVE_STRUCT_TIMESPEC],,[desc])
      AC_DEFINE([SYS_TIME_H_DEFINES_STRUCT_TIMESPEC],,[desc])
    else
	...
	AC_DEFINE([HAVE_STRUCT_TIMESPEC],,[desc])
	AC_DEFINE([PTHREAD_H_DEFINES_STRUCT_TIMESPEC],,[desc])
      fi
    fi
  fi
  AC_SUBST([TIME_H_DEFINES_STRUCT_TIMESPEC],,[desc])
  AC_SUBST([SYS_TIME_H_DEFINES_STRUCT_TIMESPEC],,[desc])
  AC_SUBST([PTHREAD_H_DEFINES_STRUCT_TIMESPEC],,[desc])
